...
class GUI(Tk):
    def __init__(self):
        ...
        # Create a new button clear_button that calls reset() method
        ...
        # Place clear_button above login_button
    ...
    # Define reset method
    def reset(self):
        # Clear the text in the name_entry using delete(0,END) method of name_entry 
