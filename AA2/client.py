...
class GUI(Tk):
    def __init__(self):
        ...
        self.name_label.place(relx = 0.35, rely = 0.2)
        self.name_entry = Entry(font = "Helvetica 14",
							bg = "#b1e5e2",
							fg = "#222222")
        self.name_entry.place(relwidth = 0.6,
                            relheight = 0.1,
                            relx = 0.2,
                            rely = 0.35)
        ...
        self.clear_button.place(relx = 0.3, rely = 0.55)
        ...
        self.login_button.place(relx = 0.5, rely = 0.55)
